...
class ModelHelperITALIC:
    """
    Wrapper class ITALIC dataset
    """

    def __init__(self, model, feature_extractor, device, language="it"):
        self.model = model
    ...
    def get_logits_from_input_embeds(self, input_embeds):
